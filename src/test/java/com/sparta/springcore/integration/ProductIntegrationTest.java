...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT) //테스트시에는 랜덤포트
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
@TestMethodOrder(MethodOrderer.OrderAnnotation.class) //@Order  사용하기위해
...
// then
        ...
        createdProduct = product; //this. 생략
    }
